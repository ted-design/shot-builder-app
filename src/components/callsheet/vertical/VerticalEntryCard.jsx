...
function VerticalEntryCard({
  ...
  return (
    <div
      ...
      className={`group relative rounded-lg border overflow-hidden transition-all ${
        isDragging
          ...
          : isSelected
          ? "border-blue-500 bg-white ring-2 ring-blue-200 shadow-md dark:bg-slate-800 dark:ring-blue-800"
    ...
    >
      ...
      <div className="flex items-center gap-3 border-b border-slate-200 bg-slate-50/80 px-4 py-3 dark:border-slate-700 dark:bg-slate-800/50">
        {/* Checkbox */}
        <input
          type="checkbox"
          checked={checked}
      ...
      {/* Body: Title, Description, Image - white background with more padding */}
      <div className="flex gap-4 p-4">
        {/* Image thumbnail (for shots) */}
        {isShot && (
          <div className="w-16 h-16 flex-shrink-0 overflow-hidden rounded-md bg-slate-100 dark:bg-slate-700 flex items-center justify-center">
            <AppImage
              src={imageUrl}
              alt=""
              fit="cover"
        ...
        <div className="min-w-0 flex-1">
          {/* Title */}
          <h4 className="font-medium text-slate-900 dark:text-slate-100 leading-snug">
      ...
      <div className="flex items-center gap-1 border-t border-slate-100 bg-slate-50/50 px-4 py-2 dark:border-slate-700 dark:bg-slate-800/30">
        {/* Flag dropdown */}
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button
        ...
        {/* Edit/Delete buttons - icon only, subtle */}
        {!isShot && (
          <button
            type="button"
            onClick={(e) => {
