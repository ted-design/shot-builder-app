  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="flex items-center gap-2 rounded-md border border-slate-200 dark:border-slate-600 bg-white dark:bg-slate-800 px-3 py-1.5 text-sm text-slate-700 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition"
      ...
      {presets.length > 0 && (
        <div className="relative" data-preset-dropdown>
          ...
          {dropdownOpen && (
            <div className="absolute right-0 z-20 mt-2 w-72 rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 p-2 shadow-lg animate-slide-in-from-right">
              <div className="mb-2 px-2 text-xs font-medium uppercase tracking-wide text-slate-500 dark:text-slate-400">
                Saved Presets
              </div>
              ...
              {presets.map(preset => (
                <div
                  ...
                  className={`group rounded-md px-2 py-2 ${
                    activePresetId === preset.id ? 'bg-primary/10 dark:bg-indigo-900/30' : 'hover:bg-slate-50 dark:hover:bg-slate-700'
                  }`}
                >
                  {editingId === preset.id ? (
                    // Edit mode
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="rounded p-1 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-700"
                        aria-label="Cancel"
                      >
                        <X className="h-4 w-4" />
                      </button>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                        <button
                          ...
                          className={`rounded p-1 transition ${
                            preset.isDefault
                              ...
                              : 'text-slate-400 dark:text-slate-500 hover:bg-slate-100 dark:hover:bg-slate-700 hover:text-amber-500'
                          }`}
                        ...
                        <button
                          ...
                          className="rounded p-1 text-slate-400 dark:text-slate-500 hover:bg-red-50 dark:hover:bg-red-900/30 hover:text-red-600 dark:hover:text-red-400"
              ...
              {activePreset && (
                <div className="mt-2 border-t border-slate-200 dark:border-slate-700 pt-2">
                  <button
                    ...
                    className="w-full rounded-md px-2 py-1.5 text-left text-sm text-slate-600 dark:text-slate-400 hover:bg-slate-50 dark:hover:bg-slate-700"
                  >
      ...
      {saveModalOpen && (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 dark:bg-black/70 backdrop-blur-sm animate-fade-in"
        ...
        >
          ...
          >
            ...
            <form onSubmit={handleSavePreset}>
              <div className="mb-4">
                <label htmlFor="preset-name" className="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">
                  Preset Name
                </label>
                <Input
                  id="preset-name"
