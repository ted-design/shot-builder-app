  ...
  return (
    <Modal open onClose={onClose} labelledBy="export-pull-title" contentClassName="max-w-2xl">
      <Card className="border-0 shadow-none">
        <CardHeader>
          <h2 id="export-pull-title" className="text-lg font-semibold text-slate-900 dark:text-slate-100">
            Export Pull
          </h2>
        ...
        <CardContent className="space-y-6">
          ...
          {format === "pdf" && (
            <>
              ...
              <div className="space-y-2">
                <div className="text-sm font-medium text-slate-700 dark:text-slate-300">Columns</div>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-1">
                  <div className="text-sm font-medium text-slate-700 dark:text-slate-300">Column widths</div>
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <label htmlFor="include-images" className="text-sm text-slate-700 dark:text-slate-300">
