    ...
    <Popover open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <Textarea
          ...
          rows={6}
          className="min-h-[140px] resize-y border-[var(--color-border)] bg-transparent text-sm leading-relaxed text-[var(--color-text)] placeholder:text-[var(--color-text-subtle)] focus-visible:border-[var(--color-primary)] focus-visible:ring-0"
          autoFocus
        />
