...
- **Email service:** `functions/email.js` sends invitation emails via Resend. Non-blocking — email failures are logged but do not block invitation creation. From address: `noreply@unboundmerino.immediategroup.ca`.
